...
(function ($window, $document) {
    ...
    $document.addEventListener('DOMContentLoaded', function () {
        ...
        (0, _srcCore.transform)(imgElement);
...
},{"../../src/core":3,"lodash":2}],2:[function(require,module,exports){
(function (global){
/**
 * @license
...
var DATA_ORIGINAL_SRC = 'data-src-original';
...
function transform(img) {
    ...
    var factor = _ref$factor === undefined ? 0.05 : _ref$factor;
    var _ref$blendMode = _ref.blendMode;
    var blendMode = _ref$blendMode === undefined ? 'overlay' : _ref$blendMode;

    var _createCanvas = createCanvas();

    var canvas = _createCanvas.canvas;
    var context = _createCanvas.context;

    var src = img.getAttribute(DATA_ORIGINAL_SRC) || img.getAttribute('src');
    var original = createImage(src);
    var size = factor * 400;
    ...
    if (!img.hasAttribute(DATA_ORIGINAL_SRC)) {
        ...
        img.setAttribute(DATA_ORIGINAL_SRC, src);
    }

    // original.addEventListener('load', function () {

        var height = Math.ceil(getDimension('height') / size) * size;
        var width = Math.ceil(getDimension('width') / size) * size;
        var small = { height: height / size, width: width / size };
        ...
        return svg
        // Define the image's src which is the newly created SVG element.
